...
import { BoardState, Player, Position, Move } from './types.ts';
import { INITIAL_BOARD, getAllPossibleMoves, executeMove, getValidMovesForPiece } from './logic/gameLogic.ts';
import Square from './components/Square.tsx';
import PieceComponent from './components/Piece.tsx';
import { analyzeBoard } from './services/geminiService.ts';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans flex flex-col items-center p-4">
      ...
      <main className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        <div className="order-2 lg:order-1 space-y-4">
          <div className="bg-zinc-900/50 p-6 rounded-2xl border border-white/5 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-950 p-4 rounded-xl text-center border border-white/5">
            ...
            <button 
              onClick={resetGame}
              className="w-full mt-6 py-3 bg-zinc-800 hover:bg-zinc-700 rounded-xl font-bold transition-colors border border-white/5"
            >
              Restart Match
            </button>
          </div>
          ...
          {winner && (
            <div className="bg-green-600 p-6 rounded-2xl animate-bounce-slow flex flex-col items-center shadow-xl">
        ...
        <div className="order-1 lg:order-2 flex justify-center">
          <div className="w-full max-w-[512px] aspect-square bg-[#18181b] p-2 rounded shadow-2xl ring-4 ring-[#27272a] overflow-hidden">
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <button 
                  ...
                  className={`px-6 py-2 rounded-full font-bold transition-all shadow-lg ${
                    isAnalyzing ? 'bg-zinc-800 cursor-not-allowed' : 'bg-amber-600 hover:bg-amber-500 hover:scale-105 shadow-amber-600/20'
                  }`}
                >
